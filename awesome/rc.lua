...
local theme_path = string.format("/home/mf/.config/awesome/theme/theme.lua", os.getenv("HOME"))
...
globalkeys = gears.table.join(
    ...
    -- lock screen
    awful.key({ modkey, "Shift" }, "l", function() awful.util.spawn_with_shell("~/.config/awesome/lock.sh") end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn("scrot -e 'mv $f ~/screenshots/ 2>/dev/null'", false) end,
...
-- Load the module:
local battery_widget = require 'bat'
